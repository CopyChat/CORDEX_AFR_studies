...
OBS_remap=(\
        'cru_ts4.00.cld.1970-1999.SA.timmean.remap.gcm.nc',\
        'cru_ts4.00.cld.1970-1999.SA.monmean.detrend.maskannual.timstd.remap.gcm.nc',\
        'cru_ts4.00.cld.1970-1999.SA.yearmean.detrend.masknoooon.timstd.remap.gcm.nc')
...
#=================================================== 
# output: N_model x ( normalized std, corr)
...
TTT1=('CMIP5','CRU','Bias','Taylor diagram')
