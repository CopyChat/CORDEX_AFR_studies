...
mean_change=np.array(mean_future-mean_ref)                 # RADS
mean_change_GCM=np.array(mean_future_GCM-mean_ref_GCM)      # RADS

#=================================================== plot
Title='Porjection Changes in RSDS(W/m2) - RCP8.5'
#=================================================== 
cmap = plt.cm.bwr
...
#plt.tight_layout()
plt.savefig('rsds_change.abs.map.gcm_vs_rcm.eps',format='eps')
plt.savefig('rsds_change.abs.map.gcm_vs_rcm.png')
plt.show()
