...
OBS_remap=(\
        'ERA_In.clt.mon.mean.1979-2005.SA.timmean.remap.rcm.nc',\
        'ERA_In.clt.mon.mean.1979-2005.SA.monmean.detrend.maskannual.timstd.remap.rcm.nc',\
        'ERA_In.clt.mon.mean.1979-2005.SA.yearmean.detrend.masknoooon.timstd.remap.rcm.nc')

filefix=(\
        '.hist_rcp85.day.1970-2099.nc.1979-2005.SA.timmean.nc',\
        '.hist_rcp85.day.1970-2099.nc.1979-2005.SA.monmean.detrended.maskannual.timstd.nc',\
        '.hist_rcp85.day.1970-2099.nc.1979-2005.SA.yearmean.detrended.masknoooon.timstd.nc')
