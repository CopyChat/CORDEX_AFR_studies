...
GCM=(\
    'pr_Amon_CNRM-CM5_historical-rcp85_r1i1p1',\
    'pr_Amon_CSIRO-Mk3-6-0_historical-rcp85_r1i1p1',\
    'pr_Amon_CanESM2_historical-rcp85_r1i1p1',\
    'pr_Amon_EC-EARTH_historical-rcp85_r1i1p1',\
    'pr_Amon_GFDL-ESM2M_historical-rcp85_r1i1p1',\
    'pr_Amon_HadGEM2-ES_historical-rcp85_r1i1p1',\
    'pr_Amon_IPSL-CM5A-LR_historical-rcp85_r1i1p1',\
    'pr_Amon_IPSL-CM5A-MR_historical-rcp85_r1i1p1',\
    'pr_Amon_MIROC5_historical-rcp85_r1i1p1',\
    'pr_Amon_MPI-ESM-LR_historical-rcp85_r1i1p1',\
    'pr_Amon_NorESM1-M_historical-rcp85_r1i1p1')
...
for r in range(N_region):
    for m in range(N_model):
        for y in range(101):
            if Anomaly2[m,r,y] > 30:
                print "kkkkkkkk",m,r,y
...
#=================================================== plot
Title='annual time series (30-year running mean) of PR along the 21st century under RCP8.5'
...
#=================================================== plot every model, RCMs and GCMs
    ...
    #for m in range(N_model):
        #axes[k].plot(TIME[15:116], Anomaly2[m,k,:],\
                #'-',linewidth=0.5)
...
#=================================================== plot runmean ensmean anomalies
    ...
    axes[k].plot(TIME[15:116],ensmean_anomaly[k],\
        '-', label='20 RCMs mean', color='blue', linewidth=2,zorder=2)
...
plt.suptitle(Title+'NCC-NorESM1-M_DMI-HIRHAM5_v1 is not here')

#===================================================  end of  plot

plt.savefig('pr.annual_series.gcm-rcm.eps', format='eps')
plt.savefig('pr.annual_series.gcm-rcm.png')
plt.show()
quit()
