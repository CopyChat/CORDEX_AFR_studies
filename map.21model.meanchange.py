...
#=================================================== 
fig, ax = plt.subplots(nrows=N_model, ncols=4,figsize=(16, 50),facecolor='w', edgecolor='k')
...
for v in range(N_var):
    for m in range(N_model):
        ...
        ctang.setMap(map)
        x,y=map(lats,lons)
        map.pcolormesh(y,x,mean_change[v,m,:,:],cmap=cmap,\
        ...
        plt.title("Exp. " + str(m+1))
        cb=plt.colorbar(orientation='horizontal',shrink=0.8) # draw colorbar
