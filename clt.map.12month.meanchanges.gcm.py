...
#=================================================== reading data
GCM_Model=(\
    'clt_CNRM-CM5.changes.ymon.mean.SA.remap.nc',\
    'clt_CanESM2.changes.ymon.mean.SA.remap.nc',\
    'clt_GFDL-ESM2M.changes.ymon.mean.SA.remap.nc',\
    'clt_HadGEM2-ES.changes.ymon.mean.SA.remap.nc',\
    'clt_IPSL-CM5A-LR.changes.ymon.mean.SA.remap.nc',\
    'clt_MIROC5.changes.ymon.mean.SA.remap.nc',\
    'clt_MPI-ESM-LR.changes.ymon.mean.SA.remap.nc',\
    'clt_NorESM1-M.changes.ymon.mean.SA.remap.nc')
...
Title=str(N_model)+' GCMs Simulated mean CLT changes (absolute %) in eath month'
...
plt.savefig('map.12month.meanchanges.gcm.clt'+'.png')
