...
OBS_remap=(\
        'SISmm.CDR.mon.mean.198301-200512.SA.timmean.remap.nc',\
        'SISmm.CDR.mon.mean.198301-200512.SA.monmean.detrended.maskannual.timstd.remap.nc',\
        'SISmm.CDR.mon.mean.198301-200512.SA.yearmean.detrended.masknoooon.timstd.remap.nc')
...
#=================================================== plot
Title='Evaluation of the simulated RSDS in the historical period 1983-2005'
#=================================================== 
Unit=( '(W/m2)','(W/m2)','(W/m2)')
#=================================================== 
...
fig.subplots_adjust(hspace=0,top=0.96,wspace=0)
#=================================================== 
LIMIT=np.array([ [150,300],[-30,30]])
...
plt.savefig('evaluation.rsds.cm_saf.by_model.png')
plt.show()
